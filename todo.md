...
## SEO Optimization
- [x] Update page title (30-60 characters) in index.html
- [x] Add meta description (50-160 characters) in index.html
- [x] Add meta keywords in index.html
- [x] Add H1 heading to Home.tsx
- [x] Add H2 headings to Home.tsx sections
